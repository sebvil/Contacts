...
import com.sebastianvm.watcher.authentication.AuthenticationTestHelpers.testRoute
import com.sebastianvm.watcher.authentication.configureAuthentication
import com.sebastianvm.watcher.configureExternalPlugins
...
suspend inline fun <reified R : WatcherRoute<*>, reified B : PostBody<R>> post(
    route: R,
    body: B,
): HttpResponse {
...
context(builder: ApplicationTestBuilder)
suspend inline fun <reified R : WatcherRoute<*>> get(route: R): HttpResponse {
